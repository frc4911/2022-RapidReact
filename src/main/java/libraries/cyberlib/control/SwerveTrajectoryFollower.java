...
public abstract class SwerveTrajectoryFollower<DriveSignalType> {
     ...
     */
    protected abstract DriveSignalType calculateDriveSignal(PoseWithCurvatureAndOrientation currentPose,
    ...
    public abstract Trajectory.State getLastState();
     ...
     */
    public final Optional<DriveSignalType> update(PoseWithCurvatureAndOrientation currentPose, Translation2d velocity,
