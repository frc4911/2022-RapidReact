...
//            reportError(ex.getMessage(), ex.getStackTrace());
        ...
        // Generate and return trajectory.
        return generateTrajectoryFromPoints(points, config);
    }
...
//            reportError(ex.getMessage(), ex.getStackTrace());
    ...
    /**
     * Generates a trajectory from the given planning points and config.
     * Depending on how these points were generated, these points can represent
     * a connected path segments that both continuous and discontinuous.  E.g.
     * the points generated by {@link libraries.cyberlib.paths.PathBuilder} lines and arc may be discontinuous
     * at the knot (or join) points.
     *
     * @param points    List of planning points.
     * @param config    The configuration for the trajectory.
     * @return The generated trajectory.
     */
    public static Trajectory generateTrajectoryFromPoints(
            List<PoseWithCurvatureAndOrientation> points,
            TrajectoryConfig config) {
//        final var flip = new Transform2d(new Translation2d(), Rotation2d.fromDegrees(180.0));
