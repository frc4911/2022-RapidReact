...
public class SwerveDriveOdometry {
    ...
    public Pose2d updateWithTime(
        ...
        // The exp() implementation gives us the delta in poses.  We need to add the delta pose to the
        // existing robot pose to accurately maintain the robot's pose over time.
