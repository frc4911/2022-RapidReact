...
public class ChassisSpeeds {
     ...
     *
     * @param vxInMetersPerSecond     The component of speed in the x direction relative to the field.
     *                                Positive x is away from your alliance wall.
     * @param vyInMetersPerSecond     The component of speed in the y direction relative to the field.
