...
public class Ports {
    ...
    // Shooter
    public static final int LEFT_FLYWHEEL  = 10; // PDP 3
    public static final int RIGHT_FLYWHEEL = 11; // PDP 12
    public static final int SHOOTER_HOOD   = 12; // PDP 6

    // Collector
    public static final int COLLECTOR        = 20; // PDP 7
    public static final int COLLECTOR_DEPLOY = 0; //Solenoid

    // Indexer
    public static final int INDEXER             = 30; // PDP 9
