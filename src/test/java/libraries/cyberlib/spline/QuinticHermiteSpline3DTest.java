...
public class QuinticHermiteSpline3DTest {
    ...
    private void run(Pose2d a, Pose2d b) {
        ...
        var spline = Spline3DHelper.getQuinticSplinesFromWaypoints(List.of(a, b))[0];
        var poses = Spline3DParameterizer.parameterize(spline);
    ...
    @Test
    void testMalformed() {
        assertThrows(Spline3DParameterizer.MalformedSplineException.class,
                () -> run(
